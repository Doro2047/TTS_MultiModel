...
法律警告（P3 安全合规）：
    ⚠️  本模块的 Prompt 延续功能可基于已有音频自动生成"后续内容"，可能产生
    衍生作品。请确保您拥有参考音频的合法授权（如自有版权内容、公有领域
    作品、或已获得版权方许可）。将受版权保护的歌曲、有声书、影视配音等
    音频作为 prompt 输入并生成衍生内容，可能构成侵权行为。使用者自行承担
    因不当使用产生的全部法律责任。
    Apache License 2.0 不授予版权许可，仅授予专利授权与代码使用许可。
"""
